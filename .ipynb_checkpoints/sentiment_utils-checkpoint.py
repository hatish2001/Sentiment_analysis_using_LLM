...
#Harishraj Udaya Bhaskar, Aushee
...
def get_prfa(dev_y: list, preds: list, verbose=False):
    ...
    """
    precision_scores=(precision_score(dev_y, preds))
    recall_scores=(recall_score(dev_y, preds))
    f1_scores=(f1_score(dev_y, preds))
    accuracy_scores=(accuracy_score(dev_y, preds))

    return tuple(precision_score, recall_score, f1_score, accuracy_scores)
